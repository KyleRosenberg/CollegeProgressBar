var currsem = setInterval(function(){loadValues(new Date(2018, 0, 16, 8), new Date(2018, 4, 9, 18), "currsem", "label")}, 15);
...
function semloop(){setValues(new Date(2018, 0, 16, 8), new Date(2018, 4, 9, 18), "currsem", "label")}
